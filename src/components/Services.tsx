      ...
      <section id="services" className="container mx-auto px-6 overflow-visible">
        <div className="max-w-4xl mx-auto text-center mb-20">
          ...
          <motion.h2 
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="text-3xl md:text-5xl font-black text-brand-navy mb-8 leading-[1.1] tracking-tighter uppercase"
          >
            ...
            >
              ...
              <div className="mt-auto space-y-4">
                {service.items.map((item) => (
                  <div key={item} className="flex items-start gap-3 text-xs text-slate-700 font-semibold leading-relaxed">
