        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.div 
              ...
              className="absolute -bottom-8 -right-8 bg-brand-navy text-white p-8 rounded-2xl shadow-2xl z-20 max-w-xs"
            >
              <p className="font-serif italic text-lg leading-relaxed">
                "La performance ne se joue pas dans les méthodes, elle se joue dans le mindset."
              </p>
            </motion.div>
          </motion.div>
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <span className="inline-block text-brand-gold font-bold text-sm uppercase tracking-widest mb-4">
              Qui suis-je ?
            </span>
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-brand-navy mb-8 leading-tight">
              Saïd Taaroust : <br />
              <span className="text-brand-gold">L'expert humaniste</span>
            </h2>
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-8">
              {certifications.map((cert, index) => (
                <motion.div 
                  ...
                  className="flex items-center gap-3 bg-white p-4 rounded-xl shadow-sm border border-brand-navy/5"
                >
