    ...
    <section id="timeline" className="container mx-auto px-6 overflow-visible relative">
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="mt-40 p-12 md:p-16 bg-brand-navy rounded-[60px] text-white flex flex-col md:flex-row items-center justify-between gap-12 max-w-6xl mx-auto shadow-2xl relative overflow-hidden group"
        >
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center gap-10">
            <div className="w-20 h-20 rounded-2xl bg-brand-orange flex items-center justify-center shrink-0 shadow-2xl rotate-3 group-hover:rotate-6 transition-transform">
          ...
          <Link href="/prendre-rendez-vous">
            <button className="relative z-10 px-10 py-5 bg-white text-brand-navy rounded-full font-black uppercase tracking-widest hover:bg-brand-orange hover:text-white transition-all transform hover:scale-105 active:scale-95 shadow-xl flex items-center gap-3 text-sm">
