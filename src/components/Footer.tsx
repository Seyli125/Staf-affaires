        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-400 text-sm leading-relaxed max-w-xs">
                L'excellence du coaching humaniste par Saïd Taaroust. Performer sans s'épuiser, manager et vendre avec sens.
              </p>
              <div className="flex gap-4">
                <Link href="https://www.linkedin.com/in/said-taaroust-staf-affaires/" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-brand-orange hover:text-black transition-all">
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li>
                  <Link href="/" className="text-gray-400 hover:text-white transition-colors text-sm font-medium">Accueil</Link>
                </li>
                <li>
                  <Link href="#services" className="text-gray-400 hover:text-white transition-colors text-sm font-medium">Services</Link>
                </li>
                <li>
                  <Link href="#features" className="text-gray-400 hover:text-white transition-colors text-sm font-medium">Qui suis-je ?</Link>
                </li>
                <li>
                  <Link href="#timeline" className="text-gray-400 hover:text-white transition-colors text-sm font-medium">Parcours</Link>
                </li>
              </ul>
            </div>
