    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="pt-40 pb-32">
        <div className="container mx-auto px-6 max-w-4xl">
          <h1 className="text-6xl font-black uppercase tracking-tighter mb-16 text-brand-navy">RGPD & Cookies</h1>
          <div className="space-y-12 text-slate-600 leading-relaxed text-lg">
            ...
            <section className="bg-slate-50 p-10 rounded-[40px] border border-slate-100">
              <h2 className="text-2xl font-black text-brand-navy uppercase tracking-tight mb-6">Notre Engagement</h2>
              <p>
            ...
            <section className="px-10">
              <h2 className="text-2xl font-black text-brand-navy uppercase tracking-tight mb-6">1. Utilisation des Cookies</h2>
            ...
            <section className="px-10">
              <h2 className="text-2xl font-black text-brand-navy uppercase tracking-tight mb-6">2. Consentement</h2>
              <p className="mb-4">
            ...
            <section className="px-10">
              <h2 className="text-2xl font-black text-brand-navy uppercase tracking-tight mb-6">3. Protection des Données</h2>
              <p className="mb-4">
            ...
            <section className="px-10">
              <h2 className="text-2xl font-black text-brand-navy uppercase tracking-tight mb-6">4. Contact DPO</h2>
              <p>
