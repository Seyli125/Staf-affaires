## Project Summary
STAF AFFAIRES is a high-end B2B coaching website designed for Saïd Taaroust. The project focuses on a premium personal brand aesthetic with a modern, responsive, and animation-rich user experience in French, centered around the philosophy "Performer sans s'épuiser".
...
- `src/components`: Reusable UI sections (Hero, Brands, Services, Timeline, etc.)
...
- High contrast and distinctive typography (Playfair Display for headings)
...
- Timeline components for professional experience
